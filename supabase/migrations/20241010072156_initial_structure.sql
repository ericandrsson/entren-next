...
CREATE TABLE "public"."places" (
    "id" integer NOT NULL DEFAULT nextval('places_place_id_seq'::regclass) PRIMARY KEY,
    "osm_id" bigint,
...
CREATE TABLE "public"."place_entrances" (
    "id" integer NOT NULL DEFAULT nextval('place_entrances_id_seq'::regclass) PRIMARY KEY,
...
CREATE TABLE "public"."staging_entity_changes" (
    "id" serial PRIMARY KEY,
    "user_id" uuid NOT NULL,
    "entity_id" integer NOT NULL,
    "entity_type" text NOT NULL CHECK (entity_type IN ('place', 'entrance', 'image')),
...
CREATE INDEX "idx_staging_entity_changes_user_id" ON public.staging_entity_changes USING btree (user_id);
CREATE INDEX "idx_staging_entity_changes_entity_id" ON public.staging_entity_changes USING btree (entity_id);
CREATE UNIQUE INDEX "unique_name" ON public.place_categories USING btree (name);

-- Foreign Keys
ALTER TABLE "public"."place_osm_tag_to_category" ADD CONSTRAINT "tag_category_mapping_place_category_id_fkey" FOREIGN KEY (category_id) REFERENCES place_categories(id) ON UPDATE CASCADE ON DELETE SET NULL;
ALTER TABLE "public"."place_categories" ADD CONSTRAINT "place_categories_parent_category_fkey" FOREIGN KEY (parent_category_id) REFERENCES place_categories(id);
ALTER TABLE "public"."place_entrances" ADD CONSTRAINT "place_entrances_place_id_fkey" FOREIGN KEY (place_id) REFERENCES places(id) ON DELETE CASCADE;
ALTER TABLE "public"."place_entrance_images" ADD CONSTRAINT "place_entrance_images_entrance_id_fkey" FOREIGN KEY (entrance_id) REFERENCES place_entrances(id);
ALTER TABLE "public"."place_entrance_images" ADD CONSTRAINT "place_entrance_images_place_id_fkey" FOREIGN KEY (place_id) REFERENCES places(id) ON DELETE CASCADE;
ALTER TABLE "public"."places" ADD CONSTRAINT "places_category_id_fkey" FOREIGN KEY (category_id) REFERENCES place_categories(id);
ALTER TABLE "public"."places" ADD CONSTRAINT "places_user_id_fkey" FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE SET NULL;
ALTER TABLE "public"."staging_entity_changes" ADD CONSTRAINT "staging_entity_changes_user_id_fkey" FOREIGN KEY (user_id) REFERENCES users(id);
ALTER TABLE "public"."audit_entity_changes" ADD CONSTRAINT "audit_entity_changes_staging_change_id_fkey" FOREIGN KEY (staging_change_id) REFERENCES staging_entity_changes(id);
ALTER TABLE "public"."audit_entity_changes" ADD CONSTRAINT "audit_entity_changes_user_id_fkey" FOREIGN KEY (user_id) REFERENCES users(id);
ALTER TABLE "public"."audit_entity_changes" ADD CONSTRAINT "audit_entity_changes_reviewed_by_fkey" FOREIGN KEY (reviewed_by) REFERENCES users(id);
...
CREATE OR REPLACE FUNCTION public.get_entrance_counts(p_place_id INTEGER)
...
ALTER TABLE "public"."staging_entity_changes" ENABLE ROW LEVEL SECURITY;
ALTER TABLE "public"."audit_entity_changes" ENABLE ROW LEVEL SECURITY;
