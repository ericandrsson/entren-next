...
INSERT INTO public.entity_json_schemas (entity_type, json_schema) VALUES
  ...
  ('entrance', '{
    ...
    "required": ["entrance_type_id", "location", "photo_filename"]
  }'::jsonb),
  ('photo', '{
    "type": "object",
    "properties": {
    ...
    "required": ["photo_filename", "place_id"]
  }'::jsonb);


-- Indexes
CREATE INDEX "idx_place_entrance_photos_place_id" ON public.place_entrance_photos USING btree (place_id);
CREATE INDEX "idx_place_entrance_photos_uploaded_by" ON public.place_entrance_photos USING btree (uploaded_by);
...
WITH verified_entrances AS (
  SELECT 
    ...
    json_agg(json_build_object(
      ...
      'photo_filename', pei.photo_filename,
