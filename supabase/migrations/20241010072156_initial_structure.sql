...
ALTER TABLE "public"."place_entrance_images" ADD CONSTRAINT "place_entrance_images_entrance_id_fkey" FOREIGN KEY (entrance_id) REFERENCES place_entrances(entrance_id);
ALTER TABLE "public"."place_entrance_images" ADD CONSTRAINT "place_entrance_images_place_id_fkey" FOREIGN KEY (place_id) REFERENCES places(place_id) ON DELETE CASCADE;
